...
#     [+] support cross-compilation on Window (native, no cygwin support)
...
#     [+] EXECUTABLE_OUTPUT_PATH is set by toolchain (required on Window)
...
set(CMAKE_GDB "${ANDROID_TOOLCHAIN_ROOT}/bin/${ANDROID_TOOLCHAIN_MACHINE_NAME}-gdb${TOOL_OS_SUFFIX}" CACHE PATH "gdb" FORCE)   # [CHANGED] Added
set(CMAKE_GDBSERVER "${ANDROID_TOOLCHAIN_ROOT}/bin/../../gdbserver" CACHE PATH "gdbserver" FORCE) # [CHANGED] Added
if (APPLE)
